...
class Dongali extends Component {
  ...
  componentWillMount() {
    ...
    console.log("파라미터로 전달 받은 값: ", post.postNum);
    console.log("게시글 번호 타입:", typeof post.postNum);
  ...
  render() {
    return (
      <div>
        ...
        {this.nickCheck() && (
          <Button
            className="clubcardmodify"
            variant="contained"
            ariant="outlined"
            onClick={this.moveHref}
          >
            수정
          </Button>
        )}
