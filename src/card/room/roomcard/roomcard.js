...
import Lovebutton from "../../market/marketcard/love_button";
  ...
  render() {
    ...
    return (
      <div>
        {/*중고마켓카드*/}
        <Card
          className="roomcardMain"
          onClick={() => this.moveHref(this.props.post.card_key)}
        >
          <img src={Ramian} className="marcketimageArea" alt="" />

          <p className="roomprice">
            <font id="roomprice">{this.props.post.card_price}</font>
          </p>
          ...
          <div id="roommodepack">
            ...
            <p className="roommode">
              <font id="mode">
                {this.props.post.card_subtitle}{" "}
                {/*구조: 투룸, 분리형(방1거실1),오픈형(방1), 복층형 */}
                <br></br>
              </font>
            </p>
          </div>
