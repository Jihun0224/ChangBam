...
class RoomWrite extends React.Component {
  ...
  onSubmit(e) {
    ...
    if (
      ...
      Object.entries(this.state.option).forEach(([key, value]) => {
        if (value === true) {
          if (options === "") options = key;
          else options = options + "," + key;
        }
      });
          ...
          <form onSubmit={this.onSubmit}>
            ...
            <FormGroup row>
              ...
              <FormControlLabel
                ...
                control={
                  <Checkbox
                    checked={this.state.option.가스레인지}
                    name="가스레인지"
                    onChange={this.optionChange}
                  />
                }
              ...
              <FormControlLabel
                ...
                control={
                  <Checkbox
                    checked={this.state.option.전자레인지}
                    name="전자레인지"
                    onChange={this.optionChange}
                  />
                }
              ...
              <FormControlLabel
                ...
                control={
                  <Checkbox
                    checked={this.state.option.wifi}
                    name="wifi"
                    onChange={this.optionChange}
                  />
                }
              ...
              <FormControlLabel
                ...
                control={
                  <Checkbox
                    checked={this.state.option.인터넷선}
                    name="인터넷선"
                    onChange={this.optionChange}
                  />
                }
