...
class Roombody extends Component {
  ...
  nickCheck() {
    if (this.state.current_nickname === this.state.nickname) {
  ...
  modify() {
    ...
    } else window.alert("판매완료된 상품의 게시물은 수정할 수 없습니다.");
  }
  ...
  soldout() {
    ...
    } else window.alert("이미 판매가 종료된 상품입니다.");
  }
    ...
    return (
      <div className="marketbody">
        <div className="img_button1">
          <IconButton>
            <img src={Right} width="30px" height="30px" alt="" />
          </IconButton>
        </div>
        <div className="img_button2">
          <IconButton>
            <img src={Left} width="30px" height="30px" alt="" />
          </IconButton>
        </div>
        <div className="market_img">
          <img src={Jgo} width="500px" height="400px" alt="" />
        </div>
