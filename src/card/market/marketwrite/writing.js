...
class Writing extends React.Component{
        ...
        if(isNaN(Number(window.location.href.slice(window.location.href.indexOf('?') + 1)))){
            ...
            .then(json =>{
                ...
                this.setState({
                    ...
                    price:json[0].card_price,
                    m_location:json[0].card_location,
    ...
    onSubmit(e){
        ...
        console.log(this.state.m_location);
        console.log(this.state.content);
        if(this.state.productName==''|| this.state.price==''|| this.state.location=='' ||this.state.content=='')
            alert("내용을 입력하세요");
        else{
            ...
            if(this.state.postNum===0){
                ...
                const post ={
                    ...
                    location:this.state.m_location,
        ...
        <Paper id="paper">
            ...
            <form onSubmit={this.onSubmit}>
                ...
                <div className="productName">
                    <TextField id="productName" type="text"  name="productName" value={this.state.productName} onChange={this.onChange}></TextField>
                </div>
                <br/>
                <p id="positionText">위치 ex)창원시 사림동 : </p>
                <div className ="m_location">
                    <TextField id="m_location" type="text"  name="m_location" value={this.state.m_location} onChange={this.onChange}></TextField>
                </div>
                <br/>
                <p id="priceText">판매가격 ex)5000 :</p>
                <div className="price">
                        <TextField id="price" type="text" name="price" value={this.state.price} onChange={this.onChange}></TextField>
                </div>
                <br/>
                ...
                <Button className="m_cancel" variant="contained" color="secondary" id="cancel" margin-left="20px" onClick={this.goBack} >취소</Button>
                 <br/>
                 <Button id="m_writing_button" type="submit" variant="contained" color="primary">글쓰기</Button>
                </form>
            </div>
        </Paper>
        );
